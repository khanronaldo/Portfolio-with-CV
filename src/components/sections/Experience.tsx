...
const JOBS = [
  ...
  { title:'Sales Executive – Health Insurance', company:'Health Life Insurance', duration:'2 Months', type:'Sales', icon:'📋', color:'var(--c3)', desc:'Promoted and sold Health insurance products, developed strong client acquisition skills, handled queries professionally, and consistently met monthly sales targets.', tags:['Client Relations','Insurance Sales','Target Achievement','Communication'] },
